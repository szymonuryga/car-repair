...
insert into mechanics(id, first_name, last_name, email, phone_number,salary) values
(1, 'Tomasz', 'Kamiński', 'tomkamiński@car-repair.com','888-034-860',4000),
(2, 'Hieronim', 'Walczak','hiewalczak@car-repair.com','781-578-787', 6000),
(3, 'Ksawery', 'Kowalski','ksakowalski@car-repair.com','728-397-530', 3500),
(4, 'Grzegorz', 'Rutkowski','grzrutkowski@car-repair.com','517-830-326', 3500),
(5, 'Radosław', 'Woźniak','radwoźniak@car-repair.com','665-795-949', 3500),
(6, 'Ireneusz', 'Kaczmarek','irekaczmarek@car-repair.com','531-176-511', 4000),
(7, 'Maksymilian', 'Nowicki','maknowicki@car-repair.com','674-216-463', 3000),
(8, 'Grzegorz', 'Duda','grzduda@car-repair.com','667-019-747', 3000);
...
(14,'WA1HJM08TNUA31202','Audi','A1','KR6504R'),
...
insert into repairs(id, start, price, car_id, category_id, client_id, mechanic_id) values
(1,'2021-05-10', 400, 1,1,1,1),
(2,'2021-05-10', 0, 2,1,2,2),
(3,'2021-05-10', 400, 2,2,3,3);